...
RequestService.prototype.send = function(method, endpoint, data, queryParams, encoding) {
...
RequestService.prototype.upload = function(endpoint, filePath, queryParams) {
